...
function Frame() {
    ...
    for (let i = 0; i < heartsRy.length; i++) {
        if (heartsRy[i].n < 18) {
            ...
            heartsRy[i].n = 0;
            // Mover al final para que los nuevos corazones estén "atrás" o "adelante" 
            // dependiendo de lo que se busque. El código original hace hearts.appendChild 
            heartsContainer.appendChild(heartsRy[i]);
        }
